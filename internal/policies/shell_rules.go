...
var shellRules = []MatrixEntry{
	...
	// ── External network (block - network=none trong sandbox) ─────────────

	{"curl ", RiskExternalNetwork, DecisionBlock,
		"Lệnh gửi HTTP request ra ngoài. Sandbox không có mạng."},
	{"wget ", RiskExternalNetwork, DecisionBlock,
		"Lệnh tải file từ mạng. Sandbox không có mạng."},
	{"nc ", RiskExternalNetwork, DecisionBlock,
		"Lệnh netcat (kết nối mạng). Sandbox không có mạng."},
	{"netcat", RiskExternalNetwork, DecisionBlock,
		"Lệnh netcat (kết nối mạng). Sandbox không có mạng."},
	{"ssh ", RiskExternalNetwork, DecisionBlock,
		"Lệnh SSH ra ngoài. Sandbox không có mạng."},
	{"scp ", RiskExternalNetwork, DecisionBlock,
		"Lệnh copy qua SSH. Sandbox không có mạng."},
