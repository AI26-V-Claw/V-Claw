...
var Registry = map[string]ToolDefinition{
	...
	"drive.searchFiles": {
		Name: "drive.searchFiles", Category: CategorySafeRead,
		Description: "Search Google Drive files",
		Dangerous:   false, RequiresConfirm: false, TimeoutMs: 30000,
		Parameters: []ParamDef{{Name: "query", Type: "string", Required: false, Description: "Drive query string"}},
	},
	"drive.getFileMetadata": {
		Name: "drive.getFileMetadata", Category: CategorySafeRead,
	...
	"drive.exportFile": {
		...
		Description: "Export a Google-native Drive file to readable content",
	...
	"docs.getDocument": {
		...
		Dangerous:   false, RequiresConfirm: false, TimeoutMs: 30000,
		Parameters: []ParamDef{{Name: "documentId", Type: "string", Required: true, Description: "Google Docs document ID"}},
	},
	...
	"sheets.listSheets": {
		Name: "sheets.listSheets", Category: CategorySafeRead,
		Description: "List sheet tabs in a spreadsheet",
		Dangerous:   false, RequiresConfirm: false, TimeoutMs: 30000,
		Parameters: []ParamDef{{Name: "spreadsheetId", Type: "string", Required: true, Description: "Spreadsheet ID"}},
	},
	"sheets.readRange": {
		Name: "sheets.readRange", Category: CategorySafeRead,
	...
	"drive.downloadFile": {
		Name: "drive.downloadFile", Category: CategoryDangerousWrite,
		Description:      "Download a Drive file to a local directory",
		DefaultRiskLevel: contracts.RiskLevelLocalWrite,
		Dangerous:        true, RequiresApproval: true, RequiresConfirm: true, TimeoutMs: 60000,
		Parameters: []ParamDef{{Name: "fileId", Type: "string", Required: true, Description: "Drive file ID"}, {Name: "outputDir", Type: "path", Required: true, Description: "Local output directory"}},
	},
	"drive.createTextFile": {
		Name: "drive.createTextFile", Category: CategoryDangerousWrite,
		Description: "Create a text-like file in Google Drive",
		Dangerous:   true, RequiresApproval: true, RequiresConfirm: true, TimeoutMs: 60000,
	...
	"drive.shareFile": {
		...
		Dangerous:   true, RequiresApproval: true, RequiresConfirm: true, TimeoutMs: 30000,
		Parameters: []ParamDef{{Name: "fileId", Type: "string", Required: true, Description: "Drive file ID"}, {Name: "role", Type: "string", Required: true, Description: "reader, commenter, or writer"}, {Name: "emailAddress", Type: "email", Required: false, Description: "Target email"}},
	},
	"docs.createDocument": {
		Name: "docs.createDocument", Category: CategoryDangerousWrite,
		Description: "Create a Google Docs document",
		Dangerous:   true, RequiresApproval: true, RequiresConfirm: true, TimeoutMs: 60000,
		Parameters: []ParamDef{{Name: "title", Type: "string", Required: true, Description: "Document title"}, {Name: "text", Type: "string", Required: false, Description: "Initial text"}},
	},
	"docs.appendText": {
	...
	"sheets.updateRange": {
		Name: "sheets.updateRange", Category: CategoryDangerousWrite,
		Description: "Update values in a Google Sheets range",
		Dangerous:   true, RequiresApproval: true, RequiresConfirm: true, TimeoutMs: 60000,
		Parameters: []ParamDef{{Name: "spreadsheetId", Type: "string", Required: true, Description: "Spreadsheet ID"}, {Name: "range", Type: "string", Required: true, Description: "A1 range"}, {Name: "values", Type: "string", Required: true, Description: "Rows to write"}},
	},
	"sheets.appendRows": {
		Name: "sheets.appendRows", Category: CategoryDangerousWrite,
		Description: "Append rows to a Google Sheets range",
		Dangerous:   true, RequiresApproval: true, RequiresConfirm: true, TimeoutMs: 60000,
		Parameters: []ParamDef{{Name: "spreadsheetId", Type: "string", Required: true, Description: "Spreadsheet ID"}, {Name: "range", Type: "string", Required: true, Description: "A1 range"}, {Name: "values", Type: "string", Required: true, Description: "Rows to append"}},
	},
}
