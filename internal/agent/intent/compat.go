...
func mapSystemOp(calls []ToolCallInfo) SystemOpType {
	for _, call := range calls {
		...
		switch {
		case name == "gmail.sendDraft" || name == "gmail.replyDraft" || name == "gmail.forwardDraft" || name == "chat.sendMessage" || name == "chat.addMember":
			return SystemOpSend
		...
		case name == "calendar.createEvent" || name == "calendar.updateEvent" || name == "gmail.createDraft" || name == "gmail.updateDraft" || name == "gmail.downloadAttachments" || name == "gmail.modifyMessage" || name == "gmail.batchModifyMessages" || name == "gmail.untrashMessage" || name == "chat.updateMessage" || name == "chat.createSpace":
