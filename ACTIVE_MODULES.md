...
| `internal/orchestration/` | Active | Wired vào agent loop trong hardening task (260616). `FailureReason` constants và `RunStatus` alignment được dùng bởi `internal/agent/runtime.go`. Subagent orchestration chỉ mở rộng theo task/approval rõ ràng. |
