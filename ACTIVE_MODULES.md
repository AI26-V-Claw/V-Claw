...
| `internal/tools/office/drive/` | Integration | Agent-callable Drive tools, ví dụ `searchFiles`, `getFileMetadata`, `exportFile`, `downloadFile`, `createTextFile`, `createFolder`, `updateTextFile`, `renameFile`, `moveFile`, `moveFiles`, `shareFile`. |
