...
| Channel adapters | Telegram receive messages, format responses, and carry approval interactions | yes | yes | no | no | in_progress | `internal/channels/telegram/*_test.go`, `internal/channels/README.md` |
